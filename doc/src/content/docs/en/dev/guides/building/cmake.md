...
```sh
$ sudo dnf install SDL2 SDL2_image SDL2_ttf SDL2_mixer freetype cmake glibc bzip2 gcc gcc-c++ zlib-ng libvorbis ncurses gettext SDL2-devel SDL2_ttf-devel SDL2_image-devel SDL2_mixer-devel flac-devel
```
